...
import manuelnunziata.buildweek4.payloads.CambioStatoFatturaDTO;
...
public class FatturaController {
    ...
    public Fattura cambiaStato(@PathVariable Long id, @RequestBody @Valid CambioStatoFatturaDTO dto, @AuthenticationPrincipal Utenti richiedente) {
